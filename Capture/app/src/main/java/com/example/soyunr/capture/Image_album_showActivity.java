    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch (Show_Choice)
        {
            ...
            case TAKE_PHOTO:{
                ...
                if (ContextCompat.checkSelfPermission(Image_album_showActivity.this,
                        Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(Image_album_showActivity.this, new
            ...
            case CHOOSE_PHOTO:
            {
                ...
                if (ContextCompat.checkSelfPermission(Image_album_showActivity.this,
                    ...
                    ActivityCompat.requestPermissions(Image_album_showActivity.this,
